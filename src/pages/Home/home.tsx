  ...
  return (    
    <div className="flex h-screen ">
      ...
      <h1 className="text-xl">Selecione os Estados</h1>
        <select onChange={handleSelectedUf} className =" border-2 rounded-md w-2/4 cursor-pointer	">
        ...
        <select onChange={handleCounties} className ="border-2 rounded-md w-2/4	cursor-pointer	">
